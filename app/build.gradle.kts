...
android {
    namespace = "com.privateinvest.aitraderpro"
    compileSdk = 34

    val alphaVantageApiKey = (project.findProperty("ALPHA_VANTAGE_API_KEY") as String?) ?: "YOUR_API_KEY_HERE"

    defaultConfig {
        applicationId = "com.privateinvest.aitraderpro"
        minSdk = 26
        targetSdk = 34
        versionCode = 2
        versionName = "0.2.0"
...
dependencies {
    ...
    // WorkManager pour la surveillance stratégique en arrière-plan
