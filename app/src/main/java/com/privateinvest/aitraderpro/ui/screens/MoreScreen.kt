    ...
    val groups = listOf(
        MoreGroup(
            ...
            listOf(
                ...
                MoreItem("market_place", "🏛️ Place du marché", "Recherche, filtres sauvegardés, tri et accès broker"),
        ...
        MoreGroup(
            ...
            listOf(
                ...
                MoreItem("operation_mode", "🟢 Synchronisation", "LIVE, SURVEILLANCE ou VEILLE + fréquences"),
